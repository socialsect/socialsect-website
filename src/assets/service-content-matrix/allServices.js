...
export const practiceWebsites = {
  ...
  hero: {
    ...
    subcopy: [
      ...
      'We build practice websites engineered from the ground up to turn the right visitors into booked appointments — with the clinical credibility and the conversion architecture to do both.',
    ],
  },
  ...
  included: {
    description: 'We design and build a conversion-optimised practice website tailored specifically to your specialty, patient mix, and growth goals. Every page is structured around how your ideal patients actually make decisions — not around how most healthcare websites are typically laid out.',
    outcomes: [
      'Higher conversion rate from visitor to enquiry',
      'Improved organic search visibility for procedure and condition terms',
      'Faster patient qualification before consultation',
      'Stronger credential and authority positioning on every page',
  ...
  process: [
    ...
    {
      name: 'Design',
      description: 'We produce a full design in Figma — desktop and mobile — before any development begins. You see exactly what you\'re getting and we iterate until it\'s right.',
      timeline: '2–3 weeks',
    },
    {
      name: 'Build',
      description: 'Development against the approved design. SEO foundations, booking integrations, tracking, and performance optimisation are all built in — not bolted on later.',
      timeline: '3–5 weeks',
    },
    {
      name: 'Content & QA',
    ...
    },
    {
      ...
      description: 'Staged launch with performance monitoring. Full CMS training and documentation so your team can manage the site confidently. Ongoing support available post-launch.',
      timeline: '3–5 days',
    },
  ],
  ...
  relatedServices: [
    {
      label: 'SEO',
      reason: 'A well-built site without an SEO strategy won\'t rank for the searches that matter. We combine both from the start for practices that want long-term organic growth.',
      path: '/services/grow/seo',
    },
    {
      label: 'Booking + management systems',
      reason: 'Your website converts visitors into enquiries — your booking system converts enquiries into appointments. Both need to work seamlessly together.',
...
export const mobileApps = {
  ...
  hero: {
    ...
    subcopy: [
      ...
      'We build patient-facing mobile apps for private practices that solve a real problem in the patient relationship — whether that\'s post-procedure care, treatment tracking, appointment management, or loyalty programmes.',
    ],
  },
  ...
  scenarios: [
    ...
    'You run a membership or loyalty programme that would benefit from a dedicated patient experience.',
  ...
  process: [
    ...
    },
    {
      ...
      timeline: '8–14 weeks (MVP)',
    },
    {
      name: 'Testing & Submission',
      description: 'Device testing, QA, App Store and Google Play submission, and any compliance or medical app regulatory review relevant to your specialty.',
      timeline: '2–3 weeks',
    },
    {
  ...
  faqs: [
    {
      ...
      answer: 'Honestly — for most practices, a great website is the right investment first. An app makes sense when there\'s a specific, recurring patient interaction that would genuinely be better in a native app context: post-op care protocols, multi-session treatment tracking, loyalty programmes, or patient-reported outcome collection. We\'ll tell you in the audit if an app is the right tool for your problem.',
    },
    {
  ...
  relatedServices: [
    {
      label: 'Booking + management systems',
      reason: 'Apps and booking systems work best when they\'re integrated from the start. A patient who books through your app should have a seamless journey into your management system.',
      path: '/services/build/systems',
    },
    {
...
export const webApplications = {
  ...
  hero: {
    ...
    subcopy: [
      ...
      'We build custom web applications for private practices and healthcare groups that replace these gaps with something that works exactly the way your practice does.',
    ],
  },
  ...
  included: {
    ...
    outcomes: [
      ...
      'A scalable operational foundation that grows with your practice or group',
      'Improved patient experience through seamless digital touchpoints',
  ...
  process: [
    ...
    },
    {
      ...
      description: 'Core functionality built and deployed to staging. Sprint-based with regular demos and stakeholder review at each sprint end.',
      timeline: '6–12 weeks',
    },
    {
...
export const bookingManagementSystems = {
  ...
  ctaHref:      '/contact/systems',

  hero: {
    headline: 'From website to booked appointment — without friction, without admin, without patients falling through the cracks.',
    subcopy: [
      'The gap between a patient deciding to book and an appointment confirmed in the diary is where most private practices lose more revenue than they realise. A phone that rings to voicemail, a booking form with no follow-up, an intake process that takes three emails — each step is a leak in the pipeline.',
      'We design, configure, and integrate the booking and patient management infrastructure that closes those leaks and makes every enquiry as easy as possible to convert.',
    ],
  },

  scenarios: [
    'You\'re losing enquiries between the website and the diary because the booking process has too much friction.',
    'Your front-of-house team spends too much time on appointment admin that should be automated.',
    'You have no automated follow-up for patients who enquire but don\'t immediately book.',
  ...
  included: {
    description: 'We audit your entire booking and patient management workflow — from first website visit to confirmed appointment and beyond — and design the system architecture that removes every unnecessary step. Then we configure, integrate, or build the tooling that makes it work.',
    outcomes: [
      'Higher enquiry-to-appointment conversion rate',
      'Reduced admin time per booking for front-of-house teams',
      'Automated follow-up for enquiries that don\'t immediately convert',
    ...
    deliverableGroups: [
      ...
      },
      {
        ...
        items: [
          ...
          'Practitioner and location utilisation dashboard',
  ...
  process: [
    {
      name: 'Workflow Audit',
      description: 'We map your current booking journey end-to-end — including every manual step, every system handoff, and every point where patients or enquiries currently disappear. The audit typically identifies more revenue leakage than expected.',
      timeline: '1 week',
    },
    {
      name: 'System Design',
    ...
    },
    {
      ...
      description: 'Setup, configuration, customisation, and integration across all components. This includes booking system, CRM, communications, intake forms, and any custom development needed for non-standard integrations.',
      timeline: '2–4 weeks',
    },
    {
      name: 'Automation Setup',
      description: 'All follow-up, reminder, post-appointment, and reactivation automation sequences are built, tested, and calibrated. Copy, timing, and channel selection (email, SMS) are all optimised for your patient type.',
      timeline: '1–2 weeks',
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'Typically within 2–3 weeks of the project start. We prioritise the highest-impact automations first — usually enquiry follow-up and appointment reminder sequences — so you start seeing conversion improvement before the full system is complete.',
    },
    {
    ...
    {
      question: 'We\'re worried about changing systems and disrupting our existing patient data. How do you handle that?',
  ...
  relatedServices: [
    ...
    {
      label: 'Google ads',
      reason: 'Paid traffic to a poorly converting booking funnel is expensive and ineffective. We often audit and fix the booking system before or alongside launching Google Ads campaigns.',
  ...
  finalCta: {
    headline: 'Every enquiry that doesn\'t become an appointment is revenue your practice has already earned and then lost. Let\'s fix that.',
  },
}
...
export const metaAds = {
  ...
  ctaHref:      '/contact/meta-ads',

  hero: {
    headline: 'Meta ads that find the patients worth finding — not just the patients worth targeting.',
    subcopy: [
      'Most healthcare Meta campaigns attract the wrong people. Broad audiences, promotional creative, and campaigns optimised for cheap leads generate a flood of low-intent enquiries that waste consultation time and damage conversion rates.',
      'We build Meta campaigns for private practices that are calibrated for patient quality, not enquiry volume — reaching the people who are genuinely ready to invest in the care you provide.',
    ],
  },

  scenarios: [
    'You\'ve run Meta ads before and got lots of enquiries from people who couldn\'t afford your fees or weren\'t genuine surgical candidates.',
  ...
  included: {
    description: 'We build, manage, and continuously optimise Meta ad campaigns for private healthcare practices — with creative strategy, audience architecture, and performance management all aligned to the specific patient type your practice wants to attract.',
    outcomes: [
      'Higher-quality enquiries with better pre-consultation intent',
    ...
    deliverableGroups: [
      ...
      },
      {
        ...
        items: [
          ...
          'Cost per enquiry and cost per booked appointment tracking',
  ...
  process: [
    {
      name: 'Audit & Strategy',
      description: 'We audit your current Meta account (if it exists), your landing pages, and your practice positioning before we build anything. The most common cause of Meta campaign failure is launching the right campaign into the wrong conversion environment.',
      timeline: '1 week',
    },
    {
      name: 'Creative & Setup',
    ...
    {
      name: 'Optimisation',
      description: 'Ongoing weekly optimisation informed by conversion data — not just Meta platform metrics. We track all the way to booked appointments, not just clicks and leads.',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'We typically recommend a minimum of £1,500–£2,000 per month in media spend for a single-service campaign to generate meaningful volume. The right budget depends on your procedure fees, your target consultation volume, and your market. We\'ll model expected outcomes against budget before you commit.',
    },
    {
  ...
  relatedServices: [
    ...
    {
      label: 'Booking + management systems',
      reason: 'Meta campaigns only generate ROI if enquiries are efficiently converted to appointments. Fixing the conversion infrastructure before or alongside launching campaigns protects every pound of ad spend.',
      path: '/services/build/systems',
    },
    {
      label: 'Video + motion',
...
export const googleAds = {
  ...
  ctaHref:      '/contact/google-ads',

  hero: {
    headline: 'Be the practice that shows up when your ideal patients are actively looking.',
    subcopy: [
      'Search advertising captures demand at its highest point — the moment a patient types "private knee surgeon London" or "dermatologist for acne Manchester" into Google. These patients have already decided they want help. They\'re choosing who to contact.',
  ...
  included: {
    ...
    outcomes: [
      ...
      'Qualified enquiries from patients actively seeking the services you provide',
      'Full attribution from ad spend to booked appointments',
      'Lower cost per acquisition over time through ongoing optimisation',
    ...
    deliverableGroups: [
      ...
      },
      {
        name: 'Campaign Management',
        items: [
          'Weekly bid strategy optimisation',
      ...
      },
      {
        ...
        items: [
          'Weekly performance dashboard',
          'Cost per enquiry and cost per booked appointment',
  ...
  process: [
    {
      ...
      description: 'We map the full search landscape for your specialty and location — identifying the terms your ideal patients use, what competitors are bidding on, and where the best opportunities are relative to your budget.',
      timeline: '1 week',
    },
    {
      name: 'Account Build',
    ...
    {
      name: 'Launch & Monitor',
      description: 'Careful launch with daily monitoring and rapid response to any performance issues. The first two weeks generate the data we need to begin meaningful optimisation.',
      timeline: 'Weeks 3–4',
    },
    {
      name: 'Optimise',
      description: 'Weekly optimisation cycles based on real performance data. Bid adjustments, negative keyword expansion, quality score improvement, and creative testing.',
      timeline: 'Monthly cycle',
    },
    {
      name: 'Scale & Expand',
  ...
  faqs: [
    {
      ...
      answer: 'For most private practice specialties in a UK or US urban market, a minimum of £1,500–£2,500 per month in media spend is needed to generate meaningful, consistent enquiry volume. The right budget for your specific specialty, location, and procedure fees depends on search volume and cost-per-click data we can model for you before you commit.',
    },
    {
    ...
    },
    {
      ...
      answer: 'We manage the account on your behalf. You have full access and transparency at all times, but the day-to-day management, optimisation, and strategy is ours. We provide monthly reporting and a strategy review so you always know what\'s happening and why.',
    },
    {
...
export const seo = {
  ...
  hero: {
    ...
    subcopy: [
      'Search engine optimisation for private practices isn\'t about ranking for "private doctor near me." It\'s about appearing in the specific searches your most valuable patients make — the procedure searches, the condition searches, the specialist searches — months before they ever pick up the phone.',
      'We build SEO programmes for private healthcare practices that build long-term, compounding organic visibility for the search terms that bring in patients worth acquiring.',
    ],
  },

  scenarios: [
    'New patients can\'t find your practice when they search for the procedures or conditions you specialise in.',
  ...
  included: {
    description: 'We build comprehensive SEO programmes for private healthcare practices — covering technical foundations, content strategy, and authority building — designed to generate compounding organic visibility for the search terms that bring in your most valuable patients.',
    outcomes: [
    ...
    deliverableGroups: [
      {
        ...
        items: [
          ...
          'Site architecture and internal linking optimisation',
      ...
      },
      {
        ...
        items: [
          ...
          'Content refresh programme for existing pages',
        ],
      },
      {
        name: 'Local SEO',
        items: [
          ...
          'Review acquisition and management programme',
        ],
      },
      {
  ...
  process: [
    ...
    },
    {
      ...
      description: 'Remediation of all technical issues identified in the audit. Site architecture improvements, speed optimisation, schema implementation, and indexing fixes. Nothing else delivers until these are right.',
      timeline: '3–4 weeks',
    },
    {
      name: 'Content Build-Out',
      description: 'Production of procedure and condition pages, FAQ content, and supporting articles — all built to both rank and convert. This is ongoing throughout the programme, prioritised by search volume and conversion value.',
      timeline: 'Months 2–6+',
    },
    {
      name: 'Authority Development',
      description: 'Link building, citation management, Google Business Profile optimisation, and digital PR. Authority accumulates over time and is the compounding element of the programme.',
      timeline: 'Months 3–12+',
    },
    {
      name: 'Monitor & Iterate',
      description: 'Monthly ranking and traffic analysis, content performance review, and programme adjustment. SEO is a continuous process, not a project with an end date.',
      timeline: 'Ongoing',
    },
  ],
  ...
  faqs: [
    {
      ...
      answer: 'Honestly — technical fixes can produce visible improvement in 4–8 weeks. Content targeting lower-competition terms can rank in 2–4 months. Building real authority for competitive specialty terms in major cities takes 6–18 months. We\'ll be clear about realistic timelines for your specific situation and prioritise the actions with the fastest impact first.',
    },
    {
      question: 'How is healthcare SEO different from general SEO?',
      answer: 'Healthcare content sits in Google\'s YMYL (Your Money or Your Life) category, which means it\'s subject to elevated scrutiny for expertise, authoritativeness, and trustworthiness (Google\'s E-E-A-T guidelines). Medical content that isn\'t attributed to qualified practitioners, doesn\'t cite evidence, or is thin and generic simply doesn\'t rank — regardless of other technical factors. Healthcare SEO requires genuine clinical expertise in the content, not just keyword optimisation.',
    },
    {
  ...
  relatedServices: [
    ...
    {
      label: 'Brand identity',
      reason: 'A strong brand identity improves SEO indirectly — through higher click-through rates on search results, better on-page engagement, and more branded searches. Patients who recognise and trust your brand find and choose you more often.',
      path: '/services/brand/identity',
    },
  ],
...
export const brandIdentity = {
  ...
  ctaHref:      '/contact/brand-identity',

  hero: {
    headline: 'A brand that tells the right patients exactly who you are — before they\'ve read a word.',
    subcopy: [
      'In private healthcare, brand is trust made visual. Patients comparing practices online make a first-impression judgement in seconds. A brand that communicates clinical authority, warmth, and the standard of your practice gets patients to lean in. A brand that doesn\'t — regardless of how good your clinical outcomes are — makes them hesitate.',
    ...
    deliverableGroups: [
      ...
      },
      {
        ...
        items: [
          ...
          'Colour palette (primary, secondary, and functional)',
  ...
  process: [
    {
      ...
      description: 'We interview key stakeholders, analyse your competitive landscape, and map the patient journey touchpoints where your brand does its most important work. This informs everything that follows.',
      timeline: '1–2 weeks',
    },
    {
    ...
    {
      name: 'Refinement',
      description: 'You select a direction and we refine it to the final standard. Logo, typography, colour, and photography style all resolved in this phase.',
      timeline: '2 weeks',
    },
    {
...
export const design = {
  ...
  hero: {
    ...
    subcopy: [
      ...
      'We handle the ongoing and one-off design work that keeps your practice looking as good as it is — across print, digital, and social — so you never have to apologise for the materials you hand a patient.',
    ],
  },
  ...
  included: {
    ...
    outcomes: [
      ...
      'Campaign assets optimised for the channels they\'re designed to appear on',
    ],
    deliverableGroups: [
      {
  ...
  process: [
    ...
    },
    {
      ...
      description: 'Final files prepared for their intended output — print-ready PDFs, web-optimised images, editable source files, or platform-specific social formats — and delivered with clear production notes.',
...
export const videoMotion = {
  ...
  included: {
    ...
    outcomes: [
      ...
      'Better performance across Meta, YouTube, and website video placements',
    ...
    deliverableGroups: [
      ...
      },
      {
        ...
        items: [
          ...
          'Animated infographics and data visualisations',
        ],
      },
    ],
  },
  ...
  process: [
    ...
    {
      name: 'Production',
      description: 'Shoot day(s) managed by our production team. We handle all direction, lighting, and audio on-site. We minimise disruption to your practice — most shoots are completed in a half or full day.',
      timeline: '1–2 shoot days',
    },
    {
      name: 'Post-production',
      description: 'Editing, colour grading, sound design, music licensing, and motion graphics. We produce multiple edits from each shoot — long-form for website, cut-downs for social, square and vertical formats for paid ads.',
      timeline: '2–3 weeks',
    },
    {
