...
const PRINCIPLES = [
  ...
  },
  {
    ...
    body:
      "I'm building Socialsect to last. I'm not optimising for the next quarter. I'm optimising for the kind of company that practice owners recommend to other practice owners for the next decade. Every decision reflects that.",
  },
]

const THANKS_TAGS = ['Author', 'Traveller', 'Boxer', 'Building Socialsect', 'New Delhi → everywhere']
        ...
        <div className="about-hero__inner">
          ...
          <div className="about-hero__body">
            <p>
              ...
              traveller, and a boxer. Not necessarily in that order depending on the week.
            </p>
            <p>
              ...
              realising. Writing it taught me something I&apos;ve tried to bring into everything I
              do since: that the most important thing you can do in any relationship  personal or
              professional  is show up honestly.
            </p>
            <p>
          ...
          <footer className="about-hero__signoff">
            ...
            <p className="about-hero__signoff-meta">
              Founder, Socialsect · Author · New Delhi, India
            </p>
          </footer>
        ...
        <div className="about-section__inner about-section__inner--narrow">
          ...
          <div className="about-section__prose">
            <p>
              ...
              was just trying to solve a problem. A specialist  brilliant at what they did,
        ...
        <div className="about-section__inner about-section__inner--narrow">
          ...
          <footer className="about-thanks__signoff">
            ...
            <p className="about-thanks__signoff-meta">
              Founder · Author of <em>A Suitcase of Memories</em> · New Delhi, India
            </p>
          </footer>
      ...
      <section className="about-closing" aria-labelledby="about-closing-heading">
        <div className="about-closing__inner">
          ...
          <div className="about-closing__actions">
            <a href="#book-call" className="about-closing__btn about-closing__btn--primary">
