...
export async function generateMetadata() {
  const data = getDermatologistsSeoLandingData('marketing-agency-for-dermatologists-dubai-marina')
  if (!data) return {}

  const canonicalUrl = 'https://gosocialsect.com/marketing-agency-for-dermatologists/dubai-marina'
...
export default async function Page() {
  const dataSlug = 'marketing-agency-for-dermatologists-dubai-marina'
