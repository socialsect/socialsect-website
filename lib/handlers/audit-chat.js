...
export async function processAuditChat(payload = {}, requestMeta = {}) {
  ...
  const analysisResult = await analyzeWebsiteAsConsultant(scanResult.checks, conversationTranscript)
