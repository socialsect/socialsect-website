...
export function classifyIntent(message) {
  ...
  // Off-topic / unrelated coding or homework requests
  if (
    msg.match(
      /\b(python|javascript|java|c\+\+|fastapi|django|react native|two sum|leetcode|homework|write.*code|backend in|frontend in|algorithm)\b/i,
    )
  ) {
    return 'off_topic';
  }
