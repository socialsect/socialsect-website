...
export async function sendChatTranscriptToTeam(conversationHistory = [], metadata = {}) {
  try {
    ...
    const html = buildChatEmailHtml(conversationHistory, overview, leadInfo, metadata)
...
function buildChatEmailHtml(conversationHistory = [], overview, leadInfo = {}, metadata = {}) {
